        ...
        <div>
          <template>
            <el-select v-model="selects.categories" placeholder="请选择">
              <el-option v-for="item in CategoriesMap" :key="item.pid" :label="item.product_name"
    ...
    <div class="main-content">
      <el-table :data="List" style="width: 100%;font-size: 15px;" border stripe>
        ...
        <el-table-column label="查看结果文件">
          <template slot-scope="scope">
            <el-button type="primary" icon="el-icon-edit" size="mini" @click="showResultDialog(scope.row)"></el-button>
          </template>
        </el-table-column>
