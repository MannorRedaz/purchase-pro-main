      ...
      <el-table-column align="right" label="操作">
        <template slot-scope="scope">
          ...
          <el-button
            size="mini"
            type="danger"
            :disabled="scope.row.school_administrator_access === 1"
    ...
    time_value: function () {
      if (this.time_value[0] != this.time_value[1]) {
        ...
        for (let i = 0; i < this.tmp.length; i++) {
          ...
          if (
            this.time_value[0] <= this.tmp[i].date &&
            this.time_value[1] >= this.tmp[i].date
          ) {
    ...
    handleList() {
      for (let i = 0; i < this.applyList.length; i++) {
        ...
        this.tableData[i].company_name =
          this.supplierList[this.applyList[i].sid].company_name;
        this.tableData[i].company_place =
          this.supplierList[this.applyList[i].sid].company_place;
        ...
        this.tableData[i].corporation =
          this.supplierList[this.applyList[i].sid].corporation;
        this.tableData[i].corporation_tel =
          this.supplierList[this.applyList[i].sid].corporation_tel;
        this.tableData[i].brief_introduction =
          this.supplierList[this.applyList[i].sid].brief_introduction;
        this.tableData[i].contract_name =
          this.supplierList[this.applyList[i].sid].contract_name;
